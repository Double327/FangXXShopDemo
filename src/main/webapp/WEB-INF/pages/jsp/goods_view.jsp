...
<head>
    ...
    <script type="text/javascript">
        ...
        function order_add() {
            location.href = "./order/add?goodsId=${goods.id}&nums=" + $("#buyNums").val();
        }

        //加入购物车
        function joinCart() {
            location.href = "./cart/add?goodsId=${goods.id}&num=" + $("#buyNums").val() + "&price=${goods.price2}";
        }
    ...
    <div class="wrapper clearfix">
                        ...
                        <dl class="cart_stats">
                            <dt class="gray f14 bold">
                                <a class="close_2 f_r" href="javascript:closeCartDiv();"
                                   title="关闭">关闭</a> <img src="<%=webPath%>/images/front/right_s.gif"
        ...
        <div>
            <div class="pic_show"
                ...
                <img src="<%=webPath%>/${goods.thumbnail}" title="${goods.name}"
                    ...
                    <ul class="ranklist">
                        <c:forEach begin="1" end="5">
                            <li class="current"><a href=""><img width="58px"
                                                                ...
                                                                src="<%=webPath%>/images/goods/apple.jpg"/></a> <a
            ...
            <div name="showBox">
                ...
                <div class="hidden comment_list box">
                    <div class="title3">
							...
							</span> <img src="<%=webPath%>/images/front/comm.gif" width="16px" height="16px"/>商品评价<span
                            class="f12 normal">
							</span>
                    </div>
                    <div>
                    ...
                    <c:if test="${not empty sessionScope.user}">
                        <div>
                            <form action="<%=webPath%>/comment/addComment" method="post">
                                <label value="评星: "/>
                ...
                <div class="hidden box">
                    <div class="title3">
                        <img src="<%=webPath%>/images/front/cart.gif" width="16" height="16" alt=""/>
