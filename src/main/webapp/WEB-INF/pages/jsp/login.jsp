                ...
                <table width="360px" class="form_table prompt_3 f_l">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <p>
                                现在免费注册成为${site}用户，便能立即享受便宜又放心的购物乐趣。<a class="blue" href="<%=request.getContextPath()%>">网站首页>></a>
                            </p>
                            <p class="mt_10">
                                <a class="reg_btn" href="<%=request.getContextPath()%>/user/toRegister">注册新用户</a>
                            </p>
                        </td>
                    </tr>
                </table>
